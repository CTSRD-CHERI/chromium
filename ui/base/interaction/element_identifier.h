...
class COMPONENT_EXPORT(UI_BASE) ElementIdentifier final {
 public:
  ...
  static ElementIdentifier FromRawValue(uintptr_t value);
...
class ClassPropertyCaster<ui::ElementIdentifier> {
 public:
#if defined(__CHERI_PURE_CAPABILITY__)
  static uintptr_t ToUIntptr(ui::ElementIdentifier x) { return x.GetRawValue(); }
  static ui::ElementIdentifier FromUIntptr(uintptr_t x) {
    return ui::ElementIdentifier::FromRawValue(base::checked_cast<uintptr_t>(x));
  }
#else // defined(__CHERI_PURE_CAPABILITY__)
