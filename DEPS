...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '64c1f912544adce31c67225db9742e1879a3da63',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '7d660c60a9bcba51b6b8ca823ef86959d477990b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '4d9fe4eb41668ede8e271987cdfd8e6108d2814f',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'quiche_revision': '4c3bb33921a9630307e29cef2eb810c9c2650d3c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ink
  # and whatever else without interference from each other.
  'ink_revision': '0dd84aaef5819ebfef2b5192eb19b79ad6855d0e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'ffmpeg_revision': '23897d62926ae74ee892ceaa5eb208c767f42371',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/angle':
    Var('chromium_cheri_git') + '/angle.git' + '@' +  Var('angle_revision'),
  ...
  'src/third_party/ffmpeg':
    Var('chromium_cheri_git') + '/chromium-ffmpeg.git' + '@' + Var('ffmpeg_revision'),
  ...
  'src/third_party/ink/src':
    Var('chromium_cheri_git') + '/ink.git' + '@' + Var('ink_revision'),
  ...
  'src/third_party/libvpx/source/libvpx':
    Var('chromium_cheri_git') + '/libvpx.git' + '@' +  '65541d419e8e6a9317acca88f86d3744ce5eb6a8',
  ...
  'src/third_party/perfetto':
    Var('chromium_cheri_git') + '/perfetto.git' + '@' + 'e0103cf051c9de733973e39f2b60de4a1d4fa5ca',
  ...
  'src/third_party/ruy/src':
    Var('chromium_cheri_git') + '/ruy.git' + '@' + 'f8b61c8dc6b2a16221368e4374b6a2939ad6d6bf',
  ...
  'src/third_party/skia':
    Var('skia_cheri_git') + '/skia.git' + '@' +  Var('skia_revision'),
  ...
  'src/third_party/tflite/src':
    Var('chromium_cheri_git') + '/tensorflow.git' + '@' + '6c45e28bba0bb5aeea9507f6b18c5dad8f6f3ba2',
  ...
  'src/third_party/spirv-tools/src': '{chromium_cheri_git}/SPIRV-Tools@31a01f007ec0a14d1ecfd3af680d8de5ad1fd273',
  'src/third_party/vulkan-headers/src': '{chromium_cheri_git}/Vulkan-Headers@7780f76b25c32ff151e2aa81a5c7b3c664e270fc',
  'src/third_party/vulkan-loader/src': '{chromium_cheri_git}/Vulkan-Loader@65bcecf9e9b6cc777b86f3a5edf58c4ea4a330eb',
  ...
  'src/v8':
    Var('chromium_cheri_git') + '/v8.git' + '@' +  Var('v8_revision'),
