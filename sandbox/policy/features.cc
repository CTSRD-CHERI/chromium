...
BASE_FEATURE(kPrintCompositorLPAC, base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kWinSboxZeroAppShim, base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kNetworkServiceCodeIntegrity, base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kWinSboxNoFakeGdiInit, base::FEATURE_DISABLED_BY_DEFAULT);
...
// Enables strict handle checks for sandboxed processes by default. If this
